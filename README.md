...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/XDkGjDnA5T)
...
```sh
npx nx serve angular-strapi-demo
```

To create a production bundle:

```sh
npx nx build angular-strapi-demo
```

To see all available targets to run for a project, run:

```sh
npx nx show project angular-strapi-demo
```
